...
C_DEPS += \
./App/Middle/sensor/current-sensor/current-sensor.d 


# Each subdirectory must supply rules for building sources it contributes
App/Middle/sensor/current-sensor/%.o App/Middle/sensor/current-sensor/%.su: ../App/Middle/sensor/current-sensor/%.c App/Middle/sensor/current-sensor/subdir.mk
...
clean: clean-App-2f-Middle-2f-sensor-2f-current-2d-sensor

clean-App-2f-Middle-2f-sensor-2f-current-2d-sensor:
	-$(RM) ./App/Middle/sensor/current-sensor/current-sensor.d ./App/Middle/sensor/current-sensor/current-sensor.o ./App/Middle/sensor/current-sensor/current-sensor.su

.PHONY: clean-App-2f-Middle-2f-sensor-2f-current-2d-sensor
